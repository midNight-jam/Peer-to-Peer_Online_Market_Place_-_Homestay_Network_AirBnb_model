...
dashboard.controller("showalllistingsController", function(data,$scope,$http ,$state,NgMap,$rootScope, $timeout,$uibModal,$stateParams,$cookies,$cookieStore,isLoggedIn,auth){
