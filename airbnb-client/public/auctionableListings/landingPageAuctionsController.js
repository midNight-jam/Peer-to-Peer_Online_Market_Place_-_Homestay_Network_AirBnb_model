dashboard.controller("landingPageAuctionsController",[
  '$scope',
  '$http',
  '$state' ,
  'logger' ,
  ...
  function($scope,$http ,$state, logger,auth,$cookies,$cookieStore){
    ...
    console.log("Hello from landingPageAuctions");

    $scope.fixedPriceLandingPage = false;
    $scope.auctionsLandingPage = true;
    ...
    $scope.slides = [
        ...
        {
            image: 'https://a0.muscacloggerhe.com/airbnb/static/engagement/p1/medium/places_mobile_med.jpg',
            id:3,
            header:"Airbnb Places",
            text:"Get lost in a city with insiders, like Woody.",
            buttontext:"See what' New",
