...
--
-- Table structure for table `auctiontrips`
--

DROP TABLE IF EXISTS `auctiontrips`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `auctiontrips` (
  `auctionTripsId` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`tripsequence`,`auctionTripsId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `auctiontrips`
--

LOCK TABLES `auctiontrips` WRITE;
/*!40000 ALTER TABLE `auctiontrips` DISABLE KEYS */;
/*!40000 ALTER TABLE `auctiontrips` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-11-26 14:32:07
